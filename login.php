...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // $cpassword1 = $_POST['cpassword'];
        ...
        $sql = "SELECT * FROM user_info where username = '$username1' AND password = '$password1' ";
    ...
    <div class="container">
        ...
        <form class="m-5" action="login.php" method="POST">
            ...
            <!-- <div class="form-group">
                ...
                <input type="cpassword" class="form-control" id="cpassword" name="cpassword"><small class="form-text text-muted">Enter same password </small>
            </div> -->
